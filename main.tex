...
当然，Brunn-Minkowski 理论涉及的内容很多，不仅有凸几何、微分几何、泛函、最优传输，还可以推广到非常丰富的应用中（如群论、环论、流形等等\footnote{一个代表例子是菲尔兹奖得主 Okounkov 的论文 Okounkov, A. (1996). \textit{Brunn–Minkowski inequality for multiplicities.Inventiones mathematicae},125(3), 405-411.}），
